...
If you are having issues with Stan or the Stan model, we suggest manually installing of *cmdstan*. The following commands will install *cmdstan* and then tell *cmdstanpy* where your install is:
